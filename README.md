...
## Reproduce All Results  ```bash python run_all.py ```  This will execute all 4 notebooks in sequence and save outputs to outputs/figures/ and outputs/tables/.  
## Repository Structure  - notebooks/   : Jupyter notebooks (one per analysis phase) - src/         : Core Python functions - outputs/     : Pre-computed figures and tables from the paper  
## Citation  [da aggiungere dopo pubblicazione]  
